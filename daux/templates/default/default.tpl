<?php
    ...
    class Template {
        ...
        private function get_separator($separator) {
            switch ($separator) {
                case 'Chevrons':
                    return ' <i class="glyphicon glyphicon-chevron-right" style="font-size:0.6em;vertical-align:20%;font-weight:normal;color:rgba(0,0,0,.6)"></i> ';
                default:
                    return $separator;
            }
        }
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $base_url; ?>prism.css">

    <style>
    pre{margin:0 !important;}
    code {color: #FF5F25 !important;}
    </style>
...
<body style="width:1000px;margin:0 auto">
    ...
    <?php } else { ?>
        ...
        <div class="container-fluid fluid-height wrapper" >
            <div class="navbar navbar-fixed-top hidden-print"  style="width:1000px;margin:0 auto;">
                        ...
                        <article>
                            ...
                            <?php } else { ?>
                                <div class="page-header">
                                    <h1><?php
                                            if ($page['breadcrumbs'] && !empty($this->get_breadcrumb_title($page, $base_page))) echo $this->get_breadcrumb_title($page, $base_page);
                                            else echo $page['title'];
                                        ?>
